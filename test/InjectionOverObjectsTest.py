...
class InjectionOverObjectsTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_mislabel_cat(self):
        self.final_fault = "mislabel_cat-100"
        self.__inject()
        ...
        self.assertEqual(len(injected_ann_ids1), 2)
    ...
    def test_mislabel_super(self):
        self.final_fault = "mislabel_super-100"
        self.__inject()
        injected_ann_ids1 = self.selected_img_ann_ids[self.test_image_id1]
    ...
    def test_incorrect_bb(self):
        self.final_fault = "incorrect_bb-100"
        self.__inject()
        injected_ann_ids1 = self.selected_img_ann_ids[self.test_image_id1]
    ...
    def test_redundant_ann(self):
        self.final_fault = "redundant_ann-100"
        self.__inject()
        ...
        self.assertEqual(len(self.before_ann_ids1) + 2, len(after_ann_ids1))

    def test_remove_ann(self):
        self.final_fault = "remove_ann-100"
        self.__inject()
